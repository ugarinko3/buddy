          ...
          <div className='login'>
            ...
            <form className='form'>
              <div className="form_item">
                <input id="formLogin" type="text" name="login" className="form_input _req" placeholder='Login'></input>
              </div>
              <div className="form_item">
                  <input id="formPassword" type={passwordVisible ? 'text' : 'password'} name="password" className="form_input _req" placeholder='Password'></input>
                  {

...
function Burger(){
    ...
    function clickBurger(){
        document.getElementById('button-header').classList.toggle("active");
        document.getElementById('header-menu-function').classList.toggle("active");
        document.getElementById('menu').classList.toggle("active");
    }
    return(
        <header class='BurgerContainer'>
        <div class='NameApp'>
            <a href='#' class='svgLogo'>
                <svg width="83" height="26" viewBox="0 0 83 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        ...
                        <stop stop-color="#78B2CD"/>
                        <stop offset="1" stop-color="#75F5C5"/>
                        </linearGradient>
                    </defs>
                </svg>
            </a>
            <div class="search">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <stop stop-color="#76D7C9"/>
                    <stop offset="1" stop-color="#75F5C5"/>
                    </linearGradient>
                    </defs>
                </svg>
            </div>
            <button onClick={clickBurger} class="button-header-burger">
                <div class='header-burger' id='button-header'>
                    <span></span>
                </div>
            </button>
            <nav class='header-menu' id="menu">
                <div class="header-menu-container" id='header-menu-function'>
                    <ul class="header-list">
                        <li>
                            <a href="" class="header-link _active-link">News</a>
                        </li>
                        <li>
                            <a href="" class="header-link">Calendar</a>
                        </li>
                        <li>
                            <a href="" class="header-link">Profile</a>
                        </li>
                        <li>
                            <a href="" class="header-link">Tournament</a>
                        </li>
                    </ul>
                </div>
            </nav>

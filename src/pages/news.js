    ...
    return(
        <div className='curator-news'>
            ...
            <div className='comment'>
                ...
                <p id='truncateText' className='valerakrutoy123'><a href='!#'>Nickname:</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod JSHADFGA,JHSDGF AEYFG YAEsaaswdcfGF ,WYAEDFHSD yajgdf eryfgc s yaefgy tempor incididunt...</p>
